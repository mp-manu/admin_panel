            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown language-switch">
                    <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <img src="/img/flags/gb.png" class="position-left" alt="">
                        English <span class="fa fa-angle-down"></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="deutsch"><img src="/img/flags/de.png" alt="">
                                Deutsch</a>
                        </li>
                        <li>
                            <a class="ukrainian"><img src="/img/flags/ua.png"
                                                      alt="">
                                Українська</a>
                        </li>
                        <li>
                            <a class="english"><img src="/img/flags/gb.png" alt="">
                                English</a>
                        </li>
                        <li>
                            <a class="espana"><img src="/img/flags/es.png" alt="">
                                España</a>
                        </li>
                        <li>
                            <a class="russian"><img src="/img/flags/ru.png" alt="">
                                Русский</a>
                        </li>
                    </ul>
                </li>
