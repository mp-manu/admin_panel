    ...
    <div class="col-lg-3 col-md-6 col-12 col-sm-6">
        <div class="blogThumb">
            <div class="thumb-center">
                <img class="img-responsive" alt="user" src="/img/course/course1.jpg">
            </div>
            ...
            <div class="card-head">
                ...
                <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                    ...
                    <li class="mdl-menu__item"><i
                                class="material-icons">print</i>Another
                        action
                    </li>
                    <li class="mdl-menu__item"><i
                ...
                <ul class="feed-blog">
                    <li class="active-feed">
                        <div class="feed-user-img">
                            <img src="/img/std/std1.jpg"
                                 class="img-radius "
                                 alt="User-Profile-Image">
                        </div>
                        <h6>
                            <span class="label label-sm label-danger">File</span>
                            Eddie uploaded
                            new files:
                            <small class="text-muted">4 hours ago</small>
                        </h6>
                        <p class="m-b-15 m-t-15">
                            hii <b> @everone</b> Please find attach documents
                            related to function.
                        </p>
                        <div class="row">
                            <div class="col-auto text-center">
                                <img src="/img/mega-img1.jpg" alt="img"
                            ...
                            <div class="col-auto text-center">
                                <img src="/img/mega-img3.jpg" alt="img"
                                     class="img-fluid img-100">
                            ...
                            <div class="col-auto text-center">
                                <img src="/img/mega-img2.jpg" alt="img"
                                     class="img-fluid img-100">
                    ...
                    <li class="diactive-feed">
                        <div class="feed-user-img">
                            <img src="/img/std/std2.jpg"
                                 class="img-radius "
                                 alt="User-Profile-Image">
                        </div>
                        <h6>
                            <span class="label label-sm label-success">Task </span>
                            Jalpa post a new task: <span class="green-color">
                    ...
                    <li class="diactive-feed">
                        <div class="feed-user-img">
                            <img src="/img/std/std3.jpg"
                                 class="img-radius "
                                 alt="User-Profile-Image">
                        </div>
                        <h6>
                            <span class="label label-sm label-primary">comment</span>
                            Jalpa post a new task: <span class="text-c-green">Please add new student details.</span>
                            <small class="text-muted">6 hours ago</small>
                        </h6>
                        <p class="m-b-15 m-t-15">
                            hii <b> @everone</b> I have completed already please
                            check it.
                        </p>
                    </li>
                    <li class="active-feed">
                        <div class="feed-user-img">
                            <img src="/img/std/std4.jpg"
                                 class="img-radius "
                                 alt="User-Profile-Image">
                        </div>
                        <h6>
                            <span class="label label-sm label-warning">Task</span>Jayesh
                            marked :
                            <span class="text-c-green"> Ready for next lecture</span>
                            <small
                                    class="text-muted">7 hours ago
                            </small>
                        </h6>
                    </li>
                </ul>
